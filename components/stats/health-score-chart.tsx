...
import type { HealthScoreStatsPoint } from "@/services/statistics-service";

type HealthScoreChartProps = {
  data: HealthScoreStatsPoint[];
};
    ...
    return (
      <div className="flex min-h-72 items-center justify-center rounded-lg border border-dashed border-cyan-200 bg-cyan-50/40 p-6 text-center">
        <p className="max-w-sm text-sm leading-6 text-slate-600">
          Le score sante apparaitra apres le premier calcul pour cet aquarium.
        </p>
      </div>
    );
  }
